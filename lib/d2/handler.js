...
D2Protocol.prototype = {
  ...
  newChannel: function(aURI) {
    ...
    let channel = Services.io.newChannel(d2_uri, aURI.originCharset, aURI).QueryInterface(Ci.nsIHttpChannel);
    ...
    // set up RPC trace information
    let trace_info = 'com.linkedin.container.rpc.trace.rpcTrace=' + DNS_SERVICE.myHostName + ',in-protocols,' + new Date();
    channel.setRequestHeader('X-LI-R2-W-IC-1', encodeURIComponent(trace_info), false);
