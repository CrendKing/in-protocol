...
let {Cc, Ci, Cm, Cu, components} = require('chrome');
...
let SCHEME = 'd2';
let DOUBLE_SLASH = '//';
let current_d2_proxy_url = fabrics.d2_proxy_urls[fabrics.default_fabric];
...
pref.pref_panel.port.on('change_fabric', function (new_fabric) {
  current_d2_proxy_url = fabrics.d2_proxy_urls[new_fabric];
});