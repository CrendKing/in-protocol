...
let SCHEME = 'eh';
let DOUBLE_SLASH = '//';
let RANGE_URL_PREFIX = 'http://range.corp.linkedin.com/range/list?%';
let RANGE_URL_SUFFIX = '.1';

function get_fabric_url_prefix(fabric) {
  return RANGE_URL_PREFIX + fabric + '.';
}
...
EHProtocol.prototype = {
  ...
  newChannel: function(aURI) {
    ...
    let eh_clusters_uri = current_eh_url_prefix + service_name + RANGE_URL_SUFFIX;
    if (metadata_name) {
